...
# See what data we are missing form our final data files that were input into the dataRetrieval function to make sure we are not missing any data we could be using
